...
class PosPackagedCard(models.Model):
    ...
    # Image for Kanban (variant first, fallback to template)
    image_128 = fields.Image(string="Image", compute="_compute_image_128", store=False)
    ...
    def _compute_image_128(self):
        for rec in self:
            ...
            if not img:
                try:
                    img = rec.product_id.product_tmpl_id.image_128
                except Exception:
                    img = False
            rec.image_128 = img
