...
class PriceCheckerWizard(models.TransientModel):
    ...
    def _onchange_barcode(self):
        ...
        # Prefer the smallest sale packaging if any
        ...
        # Render with Arabic labels exactly like screenshot
...
"""
        ...
        right_block = f"""
    <div class="pc-col">
      <div class="pc-pill pc-pill-right">{rt}</div>
      <div class="pc-price">{fmt(rv)} {sym}</div>
    </div>""" if rv is not None else ""
...
<div class="pc-kiosk">
  ...
  <div class="pc-row">
    <div class="pc-col">
      <div class="pc-pill pc-pill-left">{lt}</div>
      <div class="pc-price">{fmt(lv)} {sym}</div>
    </div>{right_block}
  </div>
</div>
"""
