# -*- coding: utf-8 -*-
{
    ...
    "data": [
        ...
        "views/price_checker_view_simple.xml",
        "views/price_checker_hide_old_menu.xml",
        "views/price_checker_cleanup_menus.xml",
        "views/price_checker_views_extend.xml"
    ],
    "assets": {
        "web.assets_backend": [
            "price_checker_kiosk_autoscan_v75321/static/src/js/price_checker_autoscan.js"
        ]
    },
    "application": True,
